...
public class OffersTest extends NonPageObjectTest {
    ...
    public static void main(String[] args) {
        ...
        firefoxOptions.setCapability(FirefoxDriver.PROFILE,geoDisabled);
       ...
       /* DesiredCapabilities capabilities =
        ...
        OffersTest offersTest = new OffersTest();
        webDriver.get("https://bstackdemo.com/");
        offersTest.signIn(webDriver,"fav_user","testingisfun99");
        offersTest.checkIfOffersAvailable(webDriver);
